#include <joaovic-project-1_inferencing.h>
...
#define FAUCET_THRESHOLD_SECS (10)
#define DRIP_THRESHOLD_SECS   (3)
//#define RAIN_THRESHOLD_SECS   (60)
#define MESSAGE_THRESHOLD_SECS (30)
#define LED_RED              22
#define LED_BLUE             24
#define DRIP_IDX             0
#define FAUCET_IDX           1
...
#define BLE_SERVICE_UUID        "39f9093c-70db-11ee-b962-0242ac120003"
#define BLE_CHARACTERISTIC_UUID "00e35c04-70dd-11ee-b962-0242ac120003"
/*
...
BLECharacteristic ble_characteristic(BLE_CHARACTERISTIC_UUID,  // standard 16-bit characteristic UUID
    BLERead | BLENotify, 20); // remote clients will be able to get notifications if this characteristic changes


void update_ble_characteristic(String message) {
    ble_characteristic.writeValue(message.c_str());
...
void ble_setup() {
    ...
    */
    ...
    BLE.setAdvertisedService(ble_service); // add the service UUID
    ble_service.addCharacteristic(ble_characteristic); // add the characteristic
    BLE.addService(ble_service); // Add the service
    ble_characteristic.writeValue("starting ble"); // set initial value for this characteristic
...
void send_alert_message(String message) {
    update_ble_characteristic(message);
}
...
void setup()
{
    ...
    send_alert_message("arduino setup done");
}
    ...
    if (central) {
        ...
        while (central.connected()) {
            ...
            while(stop_inferencing == false) {
                ...
                send_alert_message("Deu bom rapaiz");
      ...
      ei_printf("Central Conection Fail\n");
    }
}
